...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($username == '') {
    ...
    $script = $script .
      <<<EOD
            ...
            el.innerHTML = "Username cannot be empty."
  ...
  if ($password == '') {
    ...
    $script = $script .
      <<<EOD
            ...
            el.innerHTML = "Password cannot be empty."
            el.classList.remove("hidden");
      EOD;
  }
  ...
  if ($is_valid) {
    ...
    $user = $user_handler->isValidCredentials($username, $password);

    if ($user['user_found'] == 'false') {
      ...
      $script = $script .
        <<<EOD
            ...
            el.classList.remove("hidden");
      EOD;
    } else if ($user['correct_password'] == 'false') {

      $script = $script .
        <<<EOD
            el = document.querySelector(".password-error");
            el.innerHTML = "Incorrect password."
            el.classList.remove("hidden");
      EOD;
    } else {

      // All went well. Let us create a user session for this fine user.
      $user_session->createNewSession($username);
  ...
  <main class="login-page">
    <div class="intro">
      <div class="intro-image">
        <svg id="b59c9f89-c93e-413f-a14b-776784e615e2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1075.51587 646.89913">
          <title>sign_in</title>
          ...
          <path d="M397.70209,374.581a146.35424,146.35424,0,0,1-146.32,143.97c-1.72,0-3.43-.03-5.14-.09V374.581Z" transform="translate(-62.24207 -126.55043)" fill="#6c63ff" />
          <path d="M582.17908,739.45064H523.9723a31.00847,31.00847,0,0,1,58.20678,0Z" transform="translate(-62.24207 -126.55043)" fill="#6c63ff" />
          <path d="M858.24207,550.72094v122.9a61.52336,61.52336,0,0,1,0-122.9Z" transform="translate(-62.24207 -126.55043)" fill="#6c63ff" />
